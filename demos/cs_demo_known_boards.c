...
static int do_registration_tc2(struct cs_devices_t *devices)
{
  ...
  if (cpu_id[0] == 0xC0F && cpu_id[2] == 0xC07) {
    A15_0 = 0; A15_1 = 1; A7_0 = 2; A7_1 = 3; A7_2 = 4;
  } else if (cpu_id[0] == 0xC07 && cpu_id[3] == 0xC0F) {
    A7_0 = 0; A7_1 = 1; A7_2 = 2; A15_0 = 3; A15_1 = 4;
  } else {
  ...
  A15_0 = 0; A15_1 = 1; A7_0 = 2; A7_1 = 3; A7_2 = 4;
  cpu_id[A15_0] = 0xC0F; cpu_id[A15_1] = 0xC0F;
  cpu_id[A7_0] = 0xC07; cpu_id[A7_1] = 0xC07; cpu_id[A7_2] = 0xC07;
#endif
